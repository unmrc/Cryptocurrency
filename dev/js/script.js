...
(function () {
	...
	let
			...
			plugins = {
				...
				bootstrapCards:           $(".card-group-custom-styles"),
				...
				cryptoWidgets:           document.querySelectorAll('.crypto-currency-wrap')
			};
	...
	$(function () {
		 ...
		 */
		if( plugins.cryptoWidgets.length ) {
			for (let i = 0; i < plugins.cryptoWidgets.length; i++) {
				let
					node = plugins.cryptoWidgets[i],
					baseUrl = "https://widgets.cryptocompare.com/",
					scripts = document.getElementsByClassName("crypto-currency-wrap"),
					embedder = node,
					currency = node.getAttribute('data-crypto');
				...
				(function () {
					...
					s.async = true;
					var theUrl = baseUrl + 'serve/v2/coin/header?fsyms=' + currency + '&tsyms=USD';
